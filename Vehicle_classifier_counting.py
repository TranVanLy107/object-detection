...
while(video.isOpened()):
		...
		# to determine direction
            ...
            if not to.counted:
                ...
                for i,b in enumerate(boxes[0]):
                    if classes[0][i] == 1: 
                        if scores[0][i] > 0.8 and abs(center_image[1] - centroid[1]) <= 20:		
                            count_1 += 1
                    elif classes[0][i] == 2:
                        if scores[0][i] > 0.8 and abs(center_image[1] - centroid[1]) <= 20:
                            count_2 += 1
    ...
    for (objectID, centroid) in objects.items():
        if classes[0][i] == 1 and classes[0][i] == 2 and classes[0][i] == 3 and classes[0][i] == 4:
            if scores[0][i] > 0.5:
        ...
        # draw.put_number_vehi1(frame, count_1)
        # draw.put_number_vehi2(frame, count_2)
        # draw.put_number_vehi3(frame, count_3)
        # draw.put_number_vehi4(frame, count_4)
